...
export async function buildApp() {
  ...
  app.addHook('onResponse', async (req, reply) => {
    req.log.info({ statusCode: reply.statusCode, method: req.method, url: req.url, responseTime: reply.elapsedTime }, 'request completed');
  });
  ...
  app.ready(e => { if (e) app.log.error(e); });
